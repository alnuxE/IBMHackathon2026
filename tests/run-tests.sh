#!/usr/bin/env bash
# ─────────────────────────────────────────────────────────────────────────────
# Runner de pruebas automatizadas — NeoWallet (Escenario 2)
#
...
PROJECT="NeoWallet"
COLLECTION="NeoWallet.postman_collection.json"
HEALTH_URLS=("http://localhost:3000/health" "http://localhost:3001/health")
UP_SERVICES="accounts-db processor-db accounts-service processor-service"
